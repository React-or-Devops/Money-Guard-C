...
export default function CustomChart({ data }) {
  ...
  if (isDesktop)
    return <Chart data={enhancedData} height={183} showLabel={true} />;
  if (isTablet)
    return <Chart data={enhancedData} height={90} showLabel={true} />;
  if (isMobile)
    return <Chart data={enhancedData} height={80} showLabel={false} />;
